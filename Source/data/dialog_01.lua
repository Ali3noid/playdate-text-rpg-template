DIALOG_01 = {
	...
	{ id = 7,  type = "item",   speaker = "Narrator",
	 item = "wire",	text = "Za pryczem lezy cienki drut. Moze sie przydac.",	target = 8 },
	...
	{ id = 12, type = "choice", prompt = "Jak chcesz otworzyc drzwi?", options = {
			...
			{ label = "Podwaz zamek drutem",   target = 17, requireItem = "wire",
			 requireStat = { name = "Cunning", value = 3 } },
			{ label = "Zrezygnuj",             target = 2 },
	}},
	{ id = 13, type = "line",   speaker = "Ty",       text = "Przykladasz klucz do zamka.",	arget = 14 },
	...
	{ id = 21, type = "line",   speaker = "Narrator",
	 text = "Opierasz dlonie o zimna podloge i liczysz powtorzenia.",	target = 22 },
	{ id = 22, type = "stat",   speaker = "Narrator", stat = "Strength", delta = 1,
	 text = "Czujesz, jak miesnie napinaja sie pewniej.", target = 23 },
	{ id = 23, type = "line",   speaker = "Narrator",
	 text = "Odpoczywasz chwile. Moze jeszcze cos potrenowac?",	target = 20 },

	{ id = 24, type = "line",   speaker = "Narrator",
	 text = "Przygladasz sie zamkowi, liczysz plytki i szczeliny.",	target = 25 },
	{ id = 25, type = "stat",   speaker = "Narrator", stat = "Cunning",  delta = 1,
	 text = "Lepiej rozumiesz, co kryje sie w srodku mechanizmu.", target = 26 },
	{ id = 26, type = "line",   speaker = "Narrator", text = "Wyciagasz wnioski i wracasz do planu.",	target = 20 },

	{ id = 27, type = "line",   speaker = "Narrator",
	 text = "Uzywasz pryczy jako oporu, napinasz barki w statycznym napieciu.", target = 28 },
	{ id = 28, type = "stat",   speaker = "Narrator", stat = "Strength", delta = 1,
	 text = "Ramiona pracuja, czujesz dodatkowa sile.", target = 29 },
	{ id = 29, type = "line",   speaker = "Narrator", text = "Oddychasz glebiej. Czas na kolejny ruch.",	target = 20 },

	{ id = 30, type = "line",   speaker = "Narrator",
	 text = "Z wyczuciem poruszasz drutem, sluchasz klikniec i oporu.",  target = 31 },
	{ id = 31, type = "stat",   speaker = "Narrator", stat = "Cunning",  delta = 1,
	 text = "Twoj dotyk staje sie precyzyjniejszy.", target = 32 },
	{ id = 32, type = "line",   speaker = "Narrator",
	 text = "Masz wiecej pewnosci przy delikatnych czynnosciach.",	target = 20 },
}
